...
namespace DevWorld.LaContessa.API.Middleware
{
    public class ErrorHandlerMiddleware
    {
        ...
        public ErrorHandlerMiddleware(RequestDelegate next, ILogger<ErrorHandlerMiddleware> logger, LaContessaProblemDetailsFactory laContessaProblemDetailsFactory)
        {
            _next = next;
            _logger = logger;
